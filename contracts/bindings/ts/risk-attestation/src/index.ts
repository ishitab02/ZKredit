...
export interface Client {
  ...
  /**
   * Construct and simulate a attest_with_risc0 transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   * cannot be replayed to shed a worse, more recent score. On-cha
   */
  attest_with_risc0: ({wallet, data, seal, journal}: {wallet: string, data: AttestationData, seal: Buffer, journal: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>

  /**
   * Construct and simulate a set_risc0_image_id transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  set_risc0_image_id: ({image_id}: {image_id: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAEAAAAAAAAABWFkbWluAAAAAAAAEwAAAAA=",
        "",
        ...
        "",
        "",
  ...
  public readonly fromJSON = {
    get_attestation: this.txFromJSON<Option<AttestationData>>,
        ...
        attest_with_risc0: this.txFromJSON<Result<void>>,
        set_risc0_image_id: this.txFromJSON<Result<void>>,
