      ...
      <div className="container-page relative z-10">
        ...
        >
          {CAPABILITIES.map((c, i) => {
            ...
            return (
              <motion.li variants={fadeUp} key={c.word}>
                <button
                  type="button"
                ...
                >
                  <span
                    ...
                    className={cx(
                      ...
                      isActive
                        ? "opacity-100 shadow-[0_28px_80px_-30px_rgba(250,209,255,0.5)]"
                        : "opacity-0",
                    )}
                  />
                ...
                {i < CAPABILITIES.length - 1 && (
                  <span aria-hidden className="hairline block w-full md:hidden" />
                )}
              </motion.li>
            );
          })}
